      ...
      <Container>
        <Box sx={styles.contentWrapper}>
          <Box sx={styles.content}>
            <Heading as="h1">
              Equip your space with the highest quality products for <b>free</b>!
            </Heading>
            <Text as="p">
              Become an Emporooms partner and receive items from various sellers.<br/>
              All products you receive are completely <b>free</b>. All you need to do is showcase them in your space!
            </Text>
